  ...
  beforeEach(function(done) {
    ...
    request(app)
      ...
      .end(function(err, res) {
        ...
        db.models.urls.remove({url : 'http://www.roflzoo.com/'}).exec();
        db.models.users.remove({username : 'Savannah'}).exec();
        db.models.users.remove({username : 'Phillip'}).exec();
    ...
    describe('Shortening links:', function() {
      ...
      it('New links create a database entry', function(done) {
        request(app)
          ...
          .expect(200)
          .expect(function(res) {
            db.models.urls.findOne({'url' : 'http://www.roflzoo.com/'})
  ...
  describe('Account Creation:', function(){
    ...
    it('Signup creates a new user', function(done) {
      request(app)
        ...
        .expect(302)
        .expect(function() {
          db.models.users.findOne({'username': 'Svnh'})
